# Chemical Synapse
#
# The synapse simulates the axon, dendrites, and synaptic cleft of a synapse.
# The simulation is more computationally expensive than the simple counterpart,
#     but both share an interface and are thus interchangeable.
